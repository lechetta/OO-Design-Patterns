...
namespace prova.Models
{
    public class CarrinhoCompra
    {
        ...
        public static CarrinhoCompra GetCart(HttpContextBase context)
        {
            var cart = new CarrinhoCompra();
        ...
        public static CarrinhoCompra GetCart(Controller controller)
        {
            return GetCart(controller.HttpContext);
        }

        public void AddToCart(Produtct product)
        {
